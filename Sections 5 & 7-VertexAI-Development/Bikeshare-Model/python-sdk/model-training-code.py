"""
Bikeshare Demand Prediction - Model Training Code
Trains a RandomForestRegressor on the Capital Bikeshare dataset
and saves the model artifact to Google Cloud Storage.
