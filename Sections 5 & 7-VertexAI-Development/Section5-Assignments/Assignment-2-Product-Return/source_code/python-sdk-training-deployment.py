"""
Product Return - Vertex AI Python SDK: Train, Upload, Deploy, Predict
...
job = aiplatform.CustomTrainingJob(
    display_name="order-return-training-job",
...
# =====================================================
display_name = "order-return-classifier"
artifact_uri = f"gs://{BUCKET_NAME}/order-return-rf-artifact/"
...
# =====================================================
deployed_model_display_name = "order-return-endpoint"
traffic_split = {"0": 100}
...
# Reads the pre-encoded unseen orders CSV from your bucket and sends the
...
# =====================================================
unseen_uri = f"gs://{BUCKET_NAME}/order-return/orders_new.csv"
