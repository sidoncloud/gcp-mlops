"""
Cart Conversion Prediction - Model Training Code
Trains a RandomForestClassifier on the cart sessions dataset and saves the
trained model artifact to Google Cloud Storage.
...
DATA_PATH = f"gs://{BUCKET_NAME}/cart-conversion/cart_sessions_train.csv"
ARTIFACT_GCS_PATH = "cart-conversion-rf-artifact/model.joblib"
...
def preprocess_data(df: pd.DataFrame) -> tuple[pd.DataFrame, pd.Series]:
    ...
    X = df_oh.drop(columns=['converted'])
    y = df_oh['converted']
    return X, y
