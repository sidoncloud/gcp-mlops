...
pre-built scikit-learn training container. The training artifacts are written
to gs://{bucket}/training/model/ (AIP_MODEL_DIR is set by the --base-output-dir
option to give us a predictable artifact location).
...
def main() -> None:
    ...
    parser.add_argument("--display-name", default="cart-conversion-training")
    ...
    training_uri = f"gs://{args.bucket}/data/cart_sessions_train.csv"
